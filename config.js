...
window.CONFIG = {
  ...
  // ---------- PRODUTOS ----------
  products: [
    { name: 'VIP Ouro', description: 'Acesso total a comandos exclusivos, prioridade na fila e 2x salário por 30 dias.', price: 49.90, category: 'vips', image: 'https://www.magnific.com/br/imagem-ia-premium/comunicacao-vip-premium-texto-conteudo-de-alta-prioridade-para-individuos-distintos-insights-e-beneficios-unicos-adaptados-as-necessidades-de-um-publico-selecionado-e-estimado_302951524.htm#fromView=keyword&page=1&position=40&uuid=71a3983b-8ba6-46e4-95df-6692ced8d08c&track=ais_hybrid&query=Fivem+vip+assinaturas', emoji: '👑', bg: 'bg-vip', tag: 'MAIS VENDIDO' },
    { name: 'VIP Platina', description: 'Todos os benefícios do VIP Ouro + veículos exclusivos e casa personalizada.', price: 89.90, category: 'vips', image: 'https://www.magnific.com/br/imagem-ia-premium/comunicacao-vip-premium-texto-conteudo-de-alta-prioridade-para-individuos-distintos-insights-e-beneficios-unicos-adaptados-as-necessidades-de-um-publico-selecionado-e-estimado_302951524.htm#fromView=keyword&page=1&position=40&uuid=71a3983b-8ba6-46e4-95df-6692ced8d08c&track=ais_hybrid&query=Fivem+vip+assinaturas', emoji: '👑', bg: 'bg-vip', tag: 'PREMIUM' },
    { name: 'VIP Diamante', description: 'O pacote mais completo do servidor com todos os benefícios liberados.', price: 149.90, category: 'vips', image: 'https://www.magnific.com/br/imagem-ia-premium/comunicacao-vip-premium-texto-conteudo-de-alta-prioridade-para-individuos-distintos-insights-e-beneficios-unicos-adaptados-as-necessidades-de-um-publico-selecionado-e-estimado_302951524.htm#fromView=keyword&page=1&position=40&uuid=71a3983b-8ba6-46e4-95df-6692ced8d08c&track=ais_hybrid&query=Fivem+vip+assinaturas', emoji: '💎', bg: 'bg-vip', tag: 'TOP' },
